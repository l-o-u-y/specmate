...
public class Migrator20200309 implements IMigrator {
	...
	public void migrate(Connection connection) throws SpecmateException {
		createImageAttribute("model/requirements", "CEGModel");
		createImageAttribute("model/processes", "Process");
	}

	private void createImageAttribute(String packageName, String objectName) throws SpecmateException {
		IAttributeToSQLMapper aMapper = dbProvider.getAttributeToSQLMapper(packageName, getSourceVersion(),
				getTargetVersion());
		aMapper.migrateNewStringAttribute(objectName, BasePackage.Literals.IMODEL__IMAGE.getName(), "");
	}
