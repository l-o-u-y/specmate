...
/**
 * Matches the entire subtree. Can optionally specified with a regex pattern and
 * a POS tag for the root node of the subtree. If no pattern or tag is provided
 * the match is always successful.
 * 
 * @author Dominik
 *
 */
