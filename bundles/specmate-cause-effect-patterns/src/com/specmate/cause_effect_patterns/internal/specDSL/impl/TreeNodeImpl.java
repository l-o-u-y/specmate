 ...
 * </p>
 * <ul>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.TreeNodeImpl#getPTag
 * <em>PTag</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.TreeNodeImpl#getExpr
 * <em>Expr</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.TreeNodeImpl#isAnyMatch
 * <em>Any Match</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.TreeNodeImpl#getTree
 * <em>Tree</em>}</li>
 * </ul>
 *
 * @generated
...
public class TreeNodeImpl extends NodeImpl implements TreeNode {
	...
	/**
	 * The cached value of the '{@link #getTree() <em>Tree</em>}' containment
		...
		if (pTag != null && pTag.eIsProxy()) {
			...
			if (pTag != oldPTag) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecDSLPackage.TREE_NODE__PTAG, oldPTag,
							pTag));
			}
		}
		return pTag;
	...
	public void setAnyMatch(boolean newAnyMatch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.TREE_NODE__ANY_MATCH, oldAnyMatch,
					anyMatch));
	}
	...
	public NotificationChain basicSetTree(Subtree newTree, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SpecDSLPackage.TREE_NODE__TREE, oldTree, newTree);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTree(Subtree newTree) {
		if (newTree != tree) {
			...
			if (tree != null)
				msgs = ((InternalEObject) tree).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.TREE_NODE__TREE, null, msgs);
			if (newTree != null)
				msgs = ((InternalEObject) newTree).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.TREE_NODE__TREE, null, msgs);
