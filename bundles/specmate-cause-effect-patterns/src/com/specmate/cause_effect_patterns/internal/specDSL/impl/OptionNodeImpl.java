...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Option
 * Node</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.OptionNodeImpl#getLeftNode
 * <em>Left Node</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.OptionNodeImpl#getRightNodes
 * <em>Right Nodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OptionNodeImpl extends NodeImpl implements OptionNode {
	...
	/**
	 * The cached value of the '{@link #getRightNodes() <em>Right Nodes</em>}'
	...
	public NotificationChain basicSetLeftNode(ExplicitNode newLeftNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SpecDSLPackage.OPTION_NODE__LEFT_NODE, oldLeftNode, newLeftNode);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeftNode != leftNode) {
			...
			if (leftNode != null)
				msgs = ((InternalEObject) leftNode).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.OPTION_NODE__LEFT_NODE, null, msgs);
			if (newLeftNode != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.OPTION_NODE__LEFT_NODE, newLeftNode,
					newLeftNode));
	}
	...
	public EList<ExplicitNode> getRightNodes() {
		if (rightNodes == null) {
			rightNodes = new EObjectContainmentEList<ExplicitNode>(ExplicitNode.class, this,
					SpecDSLPackage.OPTION_NODE__RIGHT_NODES);
		}
		return rightNodes;
	}
