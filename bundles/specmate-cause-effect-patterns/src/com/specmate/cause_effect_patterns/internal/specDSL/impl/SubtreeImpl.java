 ...
 * '<em><b>Subtree</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.SubtreeImpl#getName
 * <em>Name</em>}</li>
 * </ul>
 *
 * @generated
		...
		if (name != null && name.eIsProxy()) {
			...
			if (name != oldName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecDSLPackage.SUBTREE__NAME, oldName,
							name));
			}
		}
		return name;
