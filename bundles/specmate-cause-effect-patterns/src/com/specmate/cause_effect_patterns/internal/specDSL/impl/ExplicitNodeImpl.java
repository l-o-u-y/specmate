 ...
 * '<em><b>Explicit Node</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.ExplicitNodeImpl#getPTag
 * <em>PTag</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.ExplicitNodeImpl#isCaseSensitive
 * <em>Case Sensitive</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.ExplicitNodeImpl#getExpr
 * <em>Expr</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.ExplicitNodeImpl#isAnyMatch
 * <em>Any Match</em>}</li>
 * </ul>
 *
 * @generated
...
public class ExplicitNodeImpl extends NodeImpl implements ExplicitNode {
	...
	/**
	 * The default value of the '{@link #isCaseSensitive() <em>Case Sensitive</em>}'
	...
	/**
	 * The cached value of the '{@link #isCaseSensitive() <em>Case Sensitive</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isCaseSensitive()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isAnyMatch() <em>Any Match</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isAnyMatch()
	 * @generated
		...
		if (pTag != null && pTag.eIsProxy()) {
			...
			if (pTag != oldPTag) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecDSLPackage.EXPLICIT_NODE__PTAG,
							oldPTag, pTag));
			}
		}
		return pTag;
	...
	public void setCaseSensitive(boolean newCaseSensitive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.EXPLICIT_NODE__CASE_SENSITIVE,
	...
	public void setAnyMatch(boolean newAnyMatch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.EXPLICIT_NODE__ANY_MATCH, oldAnyMatch,
					anyMatch));
	}
