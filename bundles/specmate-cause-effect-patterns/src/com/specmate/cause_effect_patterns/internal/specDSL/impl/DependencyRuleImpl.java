 ...
 * '<em><b>Dependency Rule</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.DependencyRuleImpl#getLeftNode
 * <em>Left Node</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.DependencyRuleImpl#getDTag
 * <em>DTag</em>}</li>
 * <li>{@link com.specmate.cause_effect_patterns.specDSL.impl.DependencyRuleImpl#getRightNode
 * <em>Right Node</em>}</li>
 * </ul>
 *
 * @generated
...
public class DependencyRuleImpl extends MinimalEObjectImpl.Container implements DependencyRule {
	/**
	 * The cached value of the '{@link #getLeftNode() <em>Left Node</em>}'
	...
	/**
	 * The cached value of the '{@link #getRightNode() <em>Right Node</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getRightNode()
	 * @generated
	...
	public NotificationChain basicSetLeftNode(Node newLeftNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SpecDSLPackage.DEPENDENCY_RULE__LEFT_NODE, oldLeftNode, newLeftNode);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setLeftNode(Node newLeftNode) {
		if (newLeftNode != leftNode) {
			...
			if (leftNode != null)
				msgs = ((InternalEObject) leftNode).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.DEPENDENCY_RULE__LEFT_NODE, null, msgs);
			if (newLeftNode != null)
				msgs = ((InternalEObject) newLeftNode).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.DEPENDENCY_RULE__LEFT_NODE, null, msgs);
			msgs = basicSetLeftNode(newLeftNode, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.DEPENDENCY_RULE__LEFT_NODE,
	...
	public DepTag getDTag() {
		if (dTag != null && dTag.eIsProxy()) {
			...
			if (dTag != oldDTag) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SpecDSLPackage.DEPENDENCY_RULE__DTAG,
							oldDTag, dTag));
			}
		}
		return dTag;
	...
	public NotificationChain basicSetRightNode(EObject newRightNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SpecDSLPackage.DEPENDENCY_RULE__RIGHT_NODE, oldRightNode, newRightNode);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRightNode(EObject newRightNode) {
		if (newRightNode != rightNode) {
			NotificationChain msgs = null;
			if (rightNode != null)
				msgs = ((InternalEObject) rightNode).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.DEPENDENCY_RULE__RIGHT_NODE, null, msgs);
			if (newRightNode != null)
				msgs = ((InternalEObject) newRightNode).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - SpecDSLPackage.DEPENDENCY_RULE__RIGHT_NODE, null, msgs);
			msgs = basicSetRightNode(newRightNode, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SpecDSLPackage.DEPENDENCY_RULE__RIGHT_NODE,
